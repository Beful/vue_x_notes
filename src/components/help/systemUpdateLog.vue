<template>  
    <div>
        <el-breadcrumb separator-class="el-icon-arrow-right" v-if="this.$router.currentRoute.path == '/help/systemUpdateLog'">
            <el-breadcrumb-item :to="{ path: '/homes' }">首页</el-breadcrumb-item>
            <el-breadcrumb-item>系统升级日志</el-breadcrumb-item>
        </el-breadcrumb><br>
...
export default{
    ...
    methods:{
        getLogList(){
            // this.getRequest("/notes/log/list",{params :this.queryInfo}).then((resp) => {
            //     if (resp.state == 2000) {
